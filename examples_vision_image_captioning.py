...
Original file is located at
    https://colab.research.google.com/drive/1Io4hcMlwcOh4Ghc-T0jsLiUrTEu0BnyJ
...
# Load the dataset
captions_mapping, text_data = load_captions_data("dataset/Flicker8k_text/Flickr8k.token.indo.txt")
